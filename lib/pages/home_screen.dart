...
class HomeScreen extends StatelessWidget {
  const HomeScreen({super.key,required this.isDarkMode,required this.setIsDarkMode});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Cooking Fun', style: TextStyle(
        fontSize: 25, fontWeight: FontWeight.w700, 
        fontStyle: FontStyle.italic, color: Theme.of(context).colorScheme.onPrimary),),
        centerTitle: true,
